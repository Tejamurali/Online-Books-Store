...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```git@github.com:Tejamurali/Online-Books-Store.git```> Select master Branch > Next > Next > Finish.
...
Step 6: Check Running The Site At  <a href="http://localhost:8086/onlinebookstore/">http://localhost:8086/onlinebookstore/</a>
